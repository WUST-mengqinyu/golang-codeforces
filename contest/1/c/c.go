...
func divUp(a, b int64) int64 { if a % b == 0{return a / b} else {return a / b + 1} }
...
func (p pairSlice) Less(i, j int) bool { if p[i].X != p[j].X {return p[i].X < p[j].X} else {return p[i].Y < p[j].Y} }
